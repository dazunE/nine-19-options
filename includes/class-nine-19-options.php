...
class Nine_19_Options {
	...
	public function __construct() {
		...
		$this->plugin_name = 'nine-19-options';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-nine-19-options-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-nine-19-options-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-nine-19-options-admin.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new Nine_19_Options_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Nine_19_Options_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Nine_19_Options_Loader    Orchestrates the hooks of the plugin.
	 */
